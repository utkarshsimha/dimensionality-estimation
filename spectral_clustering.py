...
class SpectralClustering:
    ...
    def __init__( self, n_components = 2, n_neighbors = 12, affinity = 'knn', laplacian = 'norm_sym', clustering = 'kmeans++', dist_fn = lambda x, y: np.linalg.norm(x - y), weight_fn = lambda x: 1 if x >= 0.5 else 0 ):
        ''' 
        -- PARAMS -- 
...
if __name__ == '__main__':
    X = generate_data(n_samples = 1500, data_type = 'swissroll')
